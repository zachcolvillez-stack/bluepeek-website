import { SERVICES, INDUSTRIES, u } from './site'
...
export const SERVICE_CONTENT = {
  ...
  'google-ads-management': {
    metaTitle: 'Google Ads Management for Small Business',
    metaDescription: 'Google Ads campaign setup and management for Australian service businesses, focused on qualified enquiries and transparent measurement.',
    eyebrow: 'Google Ads',
    h1: 'Google Ads built around qualified enquiries.',
    lead: 'We connect focused search campaigns with landing pages and tracking, so spend can be judged by the enquiries it creates.',
    sections: [
      { h2: 'Match the campaign to buying intent', paragraphs: ['We group keywords around specific services and locations, write direct ads and send each visitor to a page that answers the same need. This creates a clearer path from search to enquiry.'], bullets: ['Intent-led keyword and negative keyword structure', 'Dedicated landing pages where appropriate', 'Call, form and booking conversion tracking', 'Plain reporting on spend and lead activity'] },
      { h2: 'Improve the whole path', paragraphs: ['Campaign performance depends on more than the ad. We review the offer, landing page, contact options and follow-up process so strong leads are not lost after the click.'] },
      { h2: 'Decisions based on real data', paragraphs: ['We use search terms and conversion activity to reduce wasted spend and shift budget toward services and locations that generate useful enquiries.'] },
    ],
    faqs: [
      { q: 'How much should a small business spend on Google Ads?', a: 'The right budget depends on local click costs, service value and sales capacity. We recommend a test budget based on those factors rather than a fixed amount for every business.' },
      { q: 'Do I keep ownership of the advertising account?', a: 'Yes. The account and its data should remain under your business ownership.' },
      { q: 'Can you build the landing page as well?', a: 'Yes. We can create or improve campaign landing pages and connect their calls, forms and bookings to conversion tracking.' },
    ],
  },
  'review-systems': {
    metaTitle: 'Google Review Systems for Small Business',
    metaDescription: 'Customer review systems for Australian businesses: simple request flows, reminders and direct links that make genuine feedback easier to collect.',
    eyebrow: 'Review systems',
    h1: 'Make it easier for happy customers to leave a review.',
    lead: 'We create straightforward review request systems that reach real customers at the right time and direct them to the correct profile.',
    sections: [
      { h2: 'A simple request gets used', paragraphs: ['The best system removes friction. We can connect QR and NFC touchpoints, direct review links and polite follow-up messages to your existing customer process.'], bullets: ['Direct links to your verified review profile', 'QR or NFC request options', 'Email or SMS reminders when authorised', 'Clear staff instructions and handover'] },
      { h2: 'Built for genuine feedback', paragraphs: ['The system asks actual customers for an honest review. We do not fabricate reviews, filter unhappy customers into a hidden path or promise a particular rating.'] },
      { h2: 'Use feedback across the customer journey', paragraphs: ['With permission, genuine feedback can support your website, service pages and sales process. It also shows where the experience can be improved.'] },
    ],
    faqs: [
      { q: 'Can you guarantee five-star reviews?', a: 'No. Reviews must reflect genuine customer experiences. We make the request process easier and more consistent.' },
      { q: 'Can this work with Google reviews?', a: 'Yes. We can create a direct request flow for the business’s verified Google review profile.' },
      { q: 'Can customers tap a plaque to leave a review?', a: 'Yes. NFC and QR touchpoints can open the review link on a compatible phone.' },
    ],
  },
  ...
  'website-design-gold-coast': {
    metaTitle: 'Website Design Gold Coast | Custom Websites for Local Business',
    metaDescription:
      'Custom website design on the Gold Coast for local businesses. Fast, mobile-first sites built to rank on Google - no lock-in, you own everything. Free quote from Bluepeek.',
    eyebrow: 'Website Design Gold Coast',
    h1: 'Website design on the Gold Coast, built to bring in customers.',
    lead:
      'We design custom websites for Gold Coast businesses that look the part and actually generate enquiries - fast, mobile-first, and built to be found on Google.',
    sections: [
      {
        h2: 'Custom websites, not templates',
        paragraphs: [
          'A good website earns trust in the first few seconds and makes it easy for someone to call, book or enquire. We design every site from scratch around your business and the way people actually search across the Gold Coast.',
      ...
      },
      {
        ...
        paragraphs: [
          'Every site comes with the SEO foundations done properly - clean structure, fast load times, mobile usability and the local signals that help you show up when nearby customers search for what you do.',
          'We can pair your new site with lead capture and AI automation so enquiries never slip through the cracks.',
        ],
      },
      {
        h2: 'Based here, working Australia-wide',
        paragraphs: [
          'We are based at Molendinar on the Gold Coast, so you deal with a real person who knows South East Queensland - not an offshore team or an account manager. We also work with businesses right across Australia. Most sites go live in one to two weeks, with no lock-in contracts and full ownership of your domain and content.',
        ],
      },
    ],
    faqs: [
      { q: 'How much does a website cost on the Gold Coast?', a: 'Every project is custom-quoted to fit your business and goals, so you only pay for what you need. We offer Starter, Growth and Scale packages - get in touch for a free, no-obligation quote.' },
      ...
      { q: 'Do you only work with Gold Coast businesses?', a: 'No. We are based on the Gold Coast but work with businesses across Australia, including Perth, Melbourne and regional NSW. Everything can be handled remotely.' },
    ],
  },
  'ai-automation-gold-coast': {
    metaTitle: 'AI Automation Gold Coast | Lead Capture & 24/7 AI Chat',
    metaDescription:
      'AI automation for Gold Coast businesses. 24/7 AI chat, automatic enquiry capture and follow-up so you never miss a job while you are on the tools. Free quote from Bluepeek.',
    eyebrow: 'AI Automation Gold Coast',
    h1: 'AI automation for Gold Coast businesses.',
    lead:
      'Smart lead capture and AI assistants that answer enquiries, book jobs and follow up automatically - so you never lose a customer to a missed call.',
    sections: [
      {
        h2: 'Never miss an enquiry again',
        paragraphs: [
          'Most small businesses lose work simply because nobody could get to the phone. An AI assistant on your site answers common questions instantly, captures the enquiry and follows up by SMS or email while the lead is still warm.',
        ],
        bullets: [
          '24/7 AI chat trained on your services and pricing',
          'Enquiries captured and routed straight to you',
          'Automatic follow-up so leads do not go cold',
          'Works alongside your existing website',
        ],
      },
      {
        h2: 'Practical automation, not gimmicks',
        paragraphs: [
          'We only build automation that saves you time or wins you work. That usually means answering the same questions you get every week, qualifying enquiries before they reach you, and making sure every lead gets a reply within minutes.',
        ],
      },
    ],
    faqs: [
      { q: 'What can an AI assistant actually do?', a: 'It answers your common customer questions, captures enquiries with contact details, and follows up automatically. It is trained on your services, pricing and availability so the answers are accurate.' },
      { q: 'Do I need a new website for this?', a: 'No. AI chat and lead capture can be added to your existing site, though it works best alongside a site built for conversion.' },
      { q: 'Is it available outside the Gold Coast?', a: 'Yes. We are based on the Gold Coast but set this up for businesses across Australia.' },
    ],
  },
...
// Build "Explore more" internal links for a page
export function relatedLinks({ excludeService, excludeIndustry } = {}) {
  const links = []
  SERVICES.filter(s => s.slug !== excludeService).slice(0, 3).forEach(s =>
    links.push({ label: s.title, href: u.service(s.slug) }))
  INDUSTRIES.filter(i => i.slug !== excludeIndustry).slice(0, 3).forEach(i =>
