...
export const SERVICE_CONTENT = {
  'website-design-perth': {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'We’re based in Perth, so you deal with a real person who knows the local market — not an offshore team or an account manager. Most sites go live in one to two weeks, with no lock-in contracts and full ownership of your domain and content.',
        ],
      },
    ],
    faqs: [
  ...
  'lead-capture-websites': {
    ...
    metaDescription:
      'Lead capture websites for Perth businesses — designed to convert visitors into real enquiries with smart forms, click-to-call, and AI follow-up. Free quote from Bluepeek.',
    eyebrow: 'Lead Capture Websites',
    h1: 'Websites designed to capture leads, not just look good.',
    lead:
      'A pretty website that doesn’t generate enquiries is just an expensive brochure. We build lead-capture websites for Perth businesses that turn visitors into real phone calls, forms and bookings.',
    sections: [
      {
...
const INDUSTRY_DETAIL = {
  'websites-for-mechanics': {
    metaTitle: 'Websites for Mechanics Perth | Get More Bookings',
    metaDescription:
      'Websites for mechanics and auto workshops in Perth — built to bring in bookings with click-to-call, service info and online enquiries. Free quote from Bluepeek.',
    h1: 'Websites for mechanics that fill the workshop.',
    trade: 'mechanics and auto workshops',
    intro:
      'When someone’s car breaks down, they Google a local mechanic and call the first one that looks trustworthy. We build websites for Perth mechanics that show up, build trust fast, and make booking a service one tap away.',
    bullets: [
  ...
  'websites-for-barbers': {
    metaTitle: 'Websites for Barbers Perth | Fill Your Chairs',
    metaDescription:
      'Websites for barbershops in Perth — sleek, mobile-first sites with online booking, galleries and service menus that fill your chairs. Free quote from Bluepeek.',
    h1: 'Websites for barbers that keep the chairs full.',
    trade: 'barbershops',
    intro:
      'A barbershop lives and dies on bookings and reputation. We build sleek, modern websites for Perth barbers with easy online booking, a sharp gallery and a clear service menu — so new clients find you and book without the back-and-forth.',
    bullets: [
  ...
  'websites-for-painters': {
    metaTitle: 'Websites for Painters Perth | More Quote Requests',
    metaDescription:
      'Websites for painters in Perth — built to win quote requests with project galleries, clear services and easy enquiry forms. Free quote from Bluepeek.',
    h1: 'Websites for painters that win more quotes.',
    trade: 'painters and decorators',
    intro:
      'Your work speaks for itself — your website just needs to show it off and make requesting a quote easy. We build websites for Perth painters with before-and-after galleries, clear services and simple enquiry forms that turn browsers into quote requests.',
    bullets: [
  ...
  'websites-for-tradies': {
    metaTitle: 'Websites for Tradies Perth | Get Found, Get Calls',
    metaDescription:
      'Websites for tradies in Perth — plumbers, electricians, builders and more. Built to get you found on Google and bring in calls. No lock-in. Free quote from Bluepeek.',
    h1: 'Websites for tradies that get the phone ringing.',
    trade: 'tradies',
    intro:
      'You’re flat out on the tools — the last thing you’ve got time for is chasing work. We build no-nonsense websites for Perth tradies that get you found on Google, make you look professional, and turn searches into phone calls.',
    bullets: [
  ...
  'websites-for-cafes': {
    metaTitle: 'Websites for Cafes Perth | Menus, Bookings & More',
    metaDescription:
      'Websites for cafes in Perth — clean, mobile-first sites with menus, opening hours, location and bookings that bring in more customers. Free quote from Bluepeek.',
    h1: 'Websites for cafes that bring in the crowd.',
    trade: 'cafes and eateries',
    intro:
      'People check your menu, hours and vibe online before they walk in. We build beautiful, mobile-first websites for Perth cafes with menus, opening hours, location and bookings — so you turn “maybe” into walk-ins and regulars.',
    bullets: [
  ...
  'websites-for-beauty-salons': {
    metaTitle: 'Websites for Beauty Salons Perth | More Bookings',
    metaDescription:
      'Websites for beauty salons in Perth — elegant, mobile-first sites with online booking, treatment menus and galleries that fill your calendar. Free quote from Bluepeek.',
    h1: 'Websites for beauty salons that fill the calendar.',
    trade: 'beauty salons',
    intro:
      'Your clients book online, on their phone, often after hours. We build elegant websites for Perth beauty salons with seamless online booking, treatment menus and galleries — so new clients can find you and book in seconds.',
    bullets: [
...
export function industryContent(slug) {
  ...
  return {
    ...
    sections: [
      ...
      {
        h2: 'Get found by local Perth customers',
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          `We’re a Perth team — you deal with a real person, most sites go live in one to two weeks, and you own everything. No jargon, no lock-in contracts, no offshore runaround.`,
        ],
      },
    ],
    faqs: [
