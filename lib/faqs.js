...
export const HOME_FAQS = [
  ...
  { q: 'Do you only build websites on the Gold Coast?', a: 'No. Blue Peek started in Perth and still works with many Western Australian businesses. We are now based on the Gold Coast, build for clients Australia-wide, and also work with businesses in the United Kingdom and Ireland.' },
