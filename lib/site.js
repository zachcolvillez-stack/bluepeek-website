...
export const SITE = {
  ...
  description:
    'Perth web design & AI automation studio. We build fast, high-converting websites and smart lead-capture systems that get local businesses found on Google.',
...
export const CASE_STUDIES = [
  ...
  { slug: 'bluestar-mechanics',               title: 'Bluestar Mechanics',              industry: 'Mechanic',         location: 'Coburg, VIC', url: 'https://bluestarmechanics.com.au',                    image: '/screenshots/bluestar.webp' },
...
export const CLIENT_SITES = [
  ...
  { title: 'Barberz Den',           industry: 'Barbershop',   location: 'Kiara, Perth WA',  url: 'https://barberz-den.vercel.app',      image: '/screenshots/barberzden.webp' },
