...
export function organizationSchema(liveReviews) {
  ...
  return {
    ...
    knowsAbout: [
      ...
      'AI phone agents', 'Missed call recovery', 'Lead capture systems',
      'Lead follow-up automation', 'Customer review systems', 'Local SEO',
      'Generative engine optimisation', 'Google Ads', 'Small business websites',
    ...
    makesOffer: [
      ...
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'GEO & AI search optimisation' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Review and missed-call recovery systems' } },
    ],
    aggregateRating: {
