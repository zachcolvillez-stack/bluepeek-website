...
export const BLOG_POSTS = [
  {
    ...
    readTime: '7 min read',
    intro:
      'Choosing a web design agency in Perth usually comes down to three questions: what will it cost, how long will it take, and do you actually own the result. Below is a fair, factual comparison of agencies operating in the Perth market in 2026, including where Blue Peek sits, so you can compare like for like.',
    sections: [
      {
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ['Blue Peek', '$199–$499 setup + $99–$199/mo', '1–2 weeks', 'Yes, from the Growth tier'],
      ...
      },
      {
        ...
        bullets: [
          'Blue Peek: monthly-plan pricing (no large upfront project fee), 1-2 week builds, AI chatbot and lead-capture automation included from the Growth tier, no lock-in contracts, and clients own their site outright.',
    ...
    faqs: [
      { q: 'Who is the cheapest web design agency in Perth?', a: 'Pricing structures differ a lot - some agencies charge one large upfront fee, others (like Blue Peek) use a smaller setup fee plus a monthly plan. Compare the total first-year cost, not just the headline number.' },
      ...
      { q: 'Does Blue Peek only work in Perth?', a: 'Blue Peek started in Perth and covers all of Western Australia, and now also works with businesses across Australia, the United Kingdom and Ireland.' },
    ],
  },
  {
    ...
    readTime: '6 min read',
    intro:
      'Website pricing in Perth varies from a few hundred dollars to tens of thousands, depending on scope, platform and whether ongoing support is included. Here is a straightforward breakdown of what drives the price, using Blue Peek’s published tiers as an indicative example of what monthly-plan pricing looks like in practice.',
    sections: [
      {
        ...
        paragraphs: [
          'These figures reflect Blue Peek’s current published packages and are a useful reference point for the Perth market - other studios and agencies may charge a single larger upfront fee instead of a monthly plan, which changes the total cost comparison.',
        ],
      },
      {
    ...
    faqs: [
      { q: 'Is $199 realistic for a small business website?', a: 'Yes, for a simple 3-page site with a smaller monthly plan covering hosting and support - this is Blue Peek’s Starter tier as a current, real-world example.' },
      ...
      { q: 'Does the price include AI chatbot and automation?', a: 'Not always - check whether it is bundled (as it is from the Growth tier at Blue Peek) or charged as a separate add-on elsewhere.' },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'AI automation is usually bundled into a monthly website plan rather than sold as a separate expensive system - for example, it is included from Blue Peek’s Growth tier ($299 setup + $149/mo). The relevant comparison is simple: what is one extra booked job or sale worth to your business per month? For most trades and local service businesses, recovering even one or two extra jobs a month from missed enquiries comfortably covers the cost of the automation.',
        ],
      },
      {
    ...
    faqs: [
      ...
      { q: 'How much does AI automation cost for a small business in Perth?', a: 'It is commonly bundled into a monthly website plan rather than sold separately - for example, included from $149/mo on Blue Peek’s Growth tier.' },
