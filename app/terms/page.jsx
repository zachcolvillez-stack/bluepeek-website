...
export default function TermsPage() {
  return (
    <LegalLayout title="Terms of Service" updated="July 2026">
      ...
      <h2 className="text-xl font-semibold pt-2">Our services</h2>
      ...
      <h2 className="text-xl font-semibold pt-2">Fees and payment</h2>
      ...
      <h2 className="text-xl font-semibold pt-2">Ownership and content</h2>
      ...
      <h2 className="text-xl font-semibold pt-2">Cancellation</h2>
      ...
      <h2 className="text-xl font-semibold pt-2">Liability</h2>
      ...
      <h2 className="text-xl font-semibold pt-2">Contact</h2>
      <p>Questions about these terms? Email <a href={`mailto:${SITE.email}`} style={{ color: 'var(--lapiz)' }}>{SITE.email}</a>.</p>
    </LegalLayout>
  )
}
