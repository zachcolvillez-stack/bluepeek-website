...
export const HOME_FAQS = [
  ...
  { q: 'What areas do you cover?', a: 'We’re based on the Gold Coast and work with businesses right across Australia - from South East Queensland to Perth, Melbourne and regional NSW. Everything is handled remotely, so your location is not a barrier.' },
  ...
  { q: 'Do you only build websites on the Gold Coast?', a: 'No. We are based on the Gold Coast and work with businesses right across Australia - South East Queensland, Perth, Melbourne and regional NSW - as well as the United Kingdom. Everything is handled remotely, so your location is not a barrier.' },
