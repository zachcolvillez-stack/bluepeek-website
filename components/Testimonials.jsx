            ...
            >
              <div className="flex items-start gap-4">
                <div className="w-11 h-11 rounded-2xl flex items-center justify-center flex-shrink-0"
                  ...
                  <p.icon size={20} style={{ color: 'var(--lapiz-deep)' }} />
                </div>
                <div>
                  <p className="text-lg font-bold mb-2 leading-snug" style={{ color: 'var(--ink)' }}>{p.pain}</p>
                  <div className="flex items-start gap-2">
                    <span className="text-xs font-bold uppercase tracking-wider mt-1 flex-shrink-0 gradient-text">Fixed</span>
                    <p className="text-sm leading-relaxed" style={{ color: 'var(--text)' }}>{p.solution}</p>
                  </div>
                </div>
              </div>
            </motion.div>
