    ...
    <>
      ...
      <main className="relative pt-28">
        ...
        <section className="relative max-w-4xl mx-auto px-6 pb-12">
          ...
          <h1 className="text-3xl md:text-5xl font-bold tracking-tight leading-[1.1] mt-5 mb-5" style={{ color: 'var(--ink)' }}>{h1}</h1>
          <p className="text-base md:text-lg leading-relaxed max-w-2xl mb-8" style={{ color: 'var(--text)' }}>{lead}</p>
        ...
        <div className="relative max-w-4xl mx-auto px-6 py-10 space-y-12">
          {sections.map((s, i) => (
            <section key={i}>
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-4" style={{ color: 'var(--ink)' }}>{s.h2}</h2>
        ...
        {faqs.length > 0 && (
          <section className="relative max-w-4xl mx-auto px-6 py-12">
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-8" style={{ color: 'var(--ink)' }}>Frequently asked questions</h2>
