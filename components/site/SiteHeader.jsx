...
export default function SiteHeader() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-300"
      style={scrolled
        ? { background: 'rgba(255,255,255,0.82)', backdropFilter: 'blur(18px)', WebkitBackdropFilter: 'blur(18px)', borderBottom: '1px solid rgba(12,28,52,0.10)', boxShadow: '0 8px 30px rgba(12,28,52,0.08)' }
      ...
      {menuOpen && (
        <div className="md:hidden px-6 py-4 space-y-1"
          style={{ background: 'rgba(255,255,255,0.98)', backdropFilter: 'blur(18px)', borderBottom: '1px solid rgba(12,28,52,0.10)' }}>
          {links.map(l => (
