...
const STEPS = [
  {
    number: '01',
    title: 'Free Chat',
    description: "We jump on a quick call (15 minutes, no pressure) to chat about your business and what you're hoping to achieve. If we're not the right fit, we'll tell you straight up.",
  },
  {
    number: '02',
    title: 'We Build It',
    description: "We design and build your website, keeping you in the loop every step. You'll see drafts, give feedback, and we make changes until you're happy.",
  },
  {
    number: '03',
    title: 'Launch & Support',
    description: "Your new website goes live. We make sure it's running smoothly, walk you through how to use it, and stick around to help when you need us.",
  },
]
